  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: AlertDialog(
        ...
        title: Text(
            title ?? "",
            style: openSansMedium(fontSize: 20.sp,textColor: blackColor)
        ),
        content: Text(
            message,
            textAlign: textAlign,
            style: openSansMedium(fontSize: 15.sp,textColor: blackColor)
        ),
        actions: <Widget>[
          Container(
            height: 40,
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: colorDC4326, // background
                foregroundColor: Colors.blue, // foreground
              ),
              child: Text(
                  positiveText?.toUpperCase() ?? " ",
                  style: openSansSemiBold(fontSize: 15.sp,textColor: whiteColor)
              ),
            ),
          ),
          negativeText != null
