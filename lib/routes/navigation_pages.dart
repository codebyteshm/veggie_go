...
import 'package:e_commerce46/ScreensOfEcommerce/Home/binding/home_binding.dart';
import 'package:e_commerce46/ScreensOfEcommerce/Home/view/home_screen.dart';
import 'package:e_commerce46/ScreensOfEcommerce/MyOrders/binding/my_orders_binding.dart';
import 'package:e_commerce46/ScreensOfEcommerce/MyOrders/view/my_orders_screen.dart';
import 'package:e_commerce46/ScreensOfEcommerce/OrderDetails/binding/order_details_binding.dart';
import 'package:e_commerce46/ScreensOfEcommerce/OrderDetails/view/order_details_screen.dart';
...
import 'package:e_commerce46/ScreensOfEcommerce/Wallet/binding/wallet_binding.dart';
import 'package:e_commerce46/ScreensOfEcommerce/Wallet/view/wallet_dashboard_screen.dart';
...
class GetPages {
  static List<GetPage> getPages = [
    ...
    GetPage(name: RoutesConstants.loginView, page: () => LoginView(), binding: LoginBinding()), GetPage(name: RoutesConstants.homeView, page: () => HomeScreen(), binding: HomeBinding()),
    GetPage(
      name: RoutesConstants.orderSuccess,
    ...
    GetPage(
      name: RoutesConstants.myOrders,
      page: () => const MyOrdersScreen(),
      binding: MyOrdersBinding(),
    ),
    GetPage(
      name: RoutesConstants.orderDetails,
      page: () => const OrderDetailsScreen(),
      binding: OrderDetailsBinding(),
    ),
    GetPage(
      name: RoutesConstants.walletDashboard,
      page: () => const WalletDashboardScreen(),
