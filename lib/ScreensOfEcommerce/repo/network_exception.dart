...
class NoInternetException extends NetworkException {
  NoInternetException([String? message, String? path])
      : super(RequestOptions(path: path ?? ''),message ?? 'No internet connection found!');
...
class ServerConnectionException extends NetworkException {
  ServerConnectionException([String? message, String? path])
      : super(
      RequestOptions(path: path ?? ''), message ?? 'Failed to connect with server, please try again later');
}


class FetchDataException extends NetworkException {
  FetchDataException([String? message, String? path])
      : super(RequestOptions(path: path ?? ''),"Error During Communication: $message");
}
