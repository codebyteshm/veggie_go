...
// }
// Future<ProductDetailsResponse?> getProductDetailsDataFromSP() async {
//   final sp = await SharedPreferences.getInstance();
//   final user = sp.getString("productDetailsModelKey");
//   if (user == null) {
//     return null;
//   }
//   return ProductDetailsResponse.fromJson(jsonDecode(user));
// }
